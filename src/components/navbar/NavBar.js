  ...
  return (
    <div className='flex items-center justify-between   w-full px-4 h-[70px] bg-white fixed top-[0] shadow-md'>
      <h1 className='w-full text-2xl font-bold text-[#642db7]'>Panos-Katos</h1> 
       ...
       <li className='mr-[70px] hover:cursor-pointer nav_links'><a href='#home'>Home</a></li>
      ...
      <div className='flex flex-col'>
          <a onClick={handelclic} href='#home' className='hover:cursor-pointer text-[20px] mb-6  pl-3 small-nav-links'>Home</a>
