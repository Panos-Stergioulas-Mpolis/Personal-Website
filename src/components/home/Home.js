  ...
  return (
    <div className='mt-[210px] flex flex-col mx-auto items-center  w-[80%] md:w-[50%] gap-4 '> 
        ...
        <ul className='flex justify-center gap-x-[70px]'>
            <li className='hover: cursor-pointer hover:text-[blue] text-3xl'><a alt="My Github Profile" href='https://github.com/Panos-Stergioulas-Mpolis' target="_blank"><AiFillGithub size={50}/></a></li>
            <li className='hover: cursor-pointer hover:text-[blue] text-3xl'><a alt="My Linkedin Profile" href='https://www.linkedin.com/in/panagiotis-stergioulas-bolis-40a834223/' target='_blank'><AiFillLinkedin size={50}/></a></li>
        </ul>
    </div>
  )
}
